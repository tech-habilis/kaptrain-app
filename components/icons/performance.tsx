...
function IcPerformance({ size = 24, color = "#424F65" }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <G clipPath="url(#clip0_951_10493)" fill={color}>
        ...
        <Path d="M15 9l.94-2.07L18 6l-2.06-.93L15 3l-.92 2.07L12 6l2.08.93L15 9zM3.5 11L4 9l2-.5L4 8l-.5-2L3 8l-2 .5L3 9l.5 2z" />
      </G>
      <Defs>
